...
## Add a new Icon
1. Receive the small and large file from designer exported from Figma
...
1. Save those file in `/public/icons/`
1. Open those SVG files and replace all hardcoded color for `currentColor`
1. Create svg-twig file for small and large size.
1. Copy the corresponding SVG content into the svg-twig file.
