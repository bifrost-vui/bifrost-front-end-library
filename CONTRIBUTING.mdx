...
- **Global documentation** on [Zeroheight]().
...
- Roadmap: It is a urgent fix or not.

**3. Develop**
- Git: For each changes, create a new branch with the id of the Jira ticket.
- Git: Use the commit namming convention (see below).
...
- When ready, tag the branch as `ready to merge`.

**7. Wait for merge**
- Each Tuesday morning, core maintainers will merge `ready to merge` branches in master. Then build and publish a new version of the **NPM package**.
