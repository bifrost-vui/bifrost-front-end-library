...
window._genesys.widgets = {
        ...
        i18n: {
            ...
            fr: {
                ...
                webchat: {
                    ...
                    InstructionsTransfer:
                        'Ouvrez ce lien sur un autre appareil pour transférer votre session de discussion</br></br><%link%>',
                    InstructionsInvite:
                        'ShowSurveyAcceptare this link with another person to add them to this chat session</br></br><%link%>',
                    ...
                    ChatError:
                        'Un problème est survenu lors du démarrage de la session de discussion. Veuillez réessayer.',
                    ChatErrorButton: 'OK',
                    ...
                    RestoreTimeoutBody:
                        'Votre session de discussion précédente a expiré. Voulez-vous en créer un nouveau?',
                    ...
                    MonthLabels: ['Jan', 'Fév', 'Mar', 'Avr', 'Mai', 'Jun', 'Jui', 'Aou', 'Sept', 'Oct', 'Nov', 'Déc'],
                    ...
                    Errors: {
                        ...
                        ChatUnavailable:
                            'Nous sommes désolés, mais nous ne pouvons pas commencer une nouvelle discussion pour le moment. Veuillez réessayer plus tard',
                        CriticalFault:
                            "Votre session de discussion a pris fin de manière inattendue en raison d'un problème inconnu. Nous nous excusons pour le dérangement",
                        StartFailed:
                            'Un problème est survenu lors du démarrage de votre session de discussion. Veuillez vérifier votre connexion et vous assurer que vous avez correctement soumis toutes les informations requises, puis réessayez.',
                        MessageFailed: "Votre message n'a pas été reçu avec succès. Veuillez réessayer",
                        RestoreFailed:
                            "Nous sommes désolés, mais nous n'avons pas pu restaurer votre session de discussion en raison d'une erreur inconnue.",
                        TransferFailed: 'Impossible de transférer le chat pour le moment. Veuillez réessayer plus tard',
                        FileTransferSizeError:
                            "Le fichier n'a pas pu être envoyé.<br/><strong><p class='filename' title='<%FilenameFull%>'>'<%FilenameTruncated%>'</p></strong><p class='cx-advice'>La taille du fichier est supérieure à la taille autorisée (<%MaxSizePerFile%>)</p>",
                        InviteFailed:
                            'Impossible de générer une invitation pour le moment. Veuillez réessayer plus tard',
                        ChatServerWentOffline:
                            'Les messages prennent actuellement plus de temps que la normale pour passer. Nous sommes désolés pour le retard',
                        RestoredOffline:
                            'Les messages prennent actuellement plus de temps que la normale pour passer. Nous sommes désolés pour le retard',
                        ...
                        FileSendFailed:
                            "Le fichier n'a pas pu être envoyé.<br/><strong><p class='filename' title='<%FilenameFull%>'><%FilenameTruncated%></p></strong><p class='cx-advice'>Il y a eu une déconnexion imprévue. Réessayer?</p>",
                ...
                callback: {
                    ...
                    Errors: {
                        ...
                        unknownError:
                            "Quelque chose s'est mal passé, nous nous excusons pour le désagrément occasionné. Veuillez vérifier vos paramètres de connexion et réessayer.",
    ...
    callus: {
        ...
        hours: ['8am - 8pm Mon - Fri', '10am - 6pm Sat - Sun'],
    },
    sidebar: {
        showOnStartup: true,
        position: 'right',
    ...
    aTags: [
        {
            ...
            path: '../../js/widgets/genesys-live-chat/widgets.min_local.js',
        },
        {
            type: 'link',
            id: 'genesys-cx-widget-styles',
            path: '../../css/widgets/genesys-live-chat/widgets.min_local.css',
        },
    ],
});
