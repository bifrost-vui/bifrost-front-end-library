...
The system will automatically chose the best SVG file format depending the selected `size` property
...
Since Bifrost v1.3.0, you could rely on these paths to get the official and versioned icon lists:
