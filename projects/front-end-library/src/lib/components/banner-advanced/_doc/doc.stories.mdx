...
<Meta
    ...
    decorators={[
        moduleMetadata({
            declarations: [BannerAdvancedComponent, TwigContainerComponent],
        }),
        withDesign,
    ]}
    parameters={{
...
<iframe
    width="100%"
    height="450"
    src="https://www.figma.com/embed?embed_host=share&url=https%3A%2F%2Fwww.figma.com%2Ffile%2F7bTmk29aCBl7rCFszffYPr%2FDS---Components-%26-styles%3Fnode-id%3D21784%3A284582"
    frameBorder="0"
    allowFullScreen
></iframe>
