...
- The code within the tile_content editable block manages most common tile variants using embedding strategy.
- Upon redefinition within an embed Twig block, be aware that items in the editable block **won't be clickable**.
- If you need the tile content to be clickable, then use the **Tile component** instead.
