...
<Canvas
    ...
    style={{ height: '600px' }}>
    <Story
        name='Drupal - Selection Tile - vertical'
        args={{
...
>
    <Story
        name='Drupal - Selection Tile - horizontal'
        args={{
            elementPath : 'components/selection-tile/_doc/template.drupal',
            ...commonProps
        }}
...
>
    <Story
        name='Drupal - Selection Tile - with asideContent'
        args={{
            elementPath : 'components/selection-tile/_doc/template.drupal',
            asideContent: `<h5 class='mb-0'>Lorem ipsum</h5><p class='small mb-0'>Lorem ipsum dolor</p>`
        }}
    >
        {Drupal.bind({})}
    </Story>
