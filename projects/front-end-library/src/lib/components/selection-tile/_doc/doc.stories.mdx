...
<Meta
    ...
    argTypes={{
        ...
        errorMessage : {
            type : { required: false },
            description : 'supports only the following html tags:  &lt;br&gt;, &lt;em&gt;, &lt;i&gt;, &lt;strong&gt;,&lt;b&gt;, &lt;sup&gt;, &lt;sub&gt;',
        },
    }}
/>
...
- The *Selection Tile* comes in 4 layout combinations are : 
    ...
    - `large` + `vertical`     
    - `horizontal` variant won't display `image`
    - `small` variant won't display `info` content
