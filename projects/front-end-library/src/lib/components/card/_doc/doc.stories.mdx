...
export const comboCommonProps = {
    ...
    image           : {
        src             : 'https://videotron.com/sites/default/files/styles/original/public/tab_tmo/telephones/motorola/motogstylus/motorola-moto-g-stylus-indigo-mystique-1200.webp?itok=IzbjmMox',
        alt             : 'iPhone 12 Mini',
        comboLabel      : '250 Go',
    },
    visualBackgroundColor : '',
