...
| Prop Name                       | Plan | Phone | Protection | Increment | Combo | Loading |
| ------------------------------- | :--: | :---: | :--------: | :-------: | :---: | :-----: |
| buttons                         |  ✓   |   ✓   |     ✓      |     ✓     |   ✓   |         |
| class                           |  ✓   |   ✓   |     ✓      |     ✓     |   ✓   |    ✓    |
| comboLabel                      |      |       |            |           |   ✓   |         |
...
{% include '@bf-components/card/twig/increment.twig' with {...} %}
...
{% include '@bf-components/card/twig/plan.twig' with {
    ...
    price: {
        ...
        byod_promotion: {
            enabled: true,
            label_off: 'Avec l’ajout d’un nouveau téléphone',
            label_on: 'En apportant votre téléphone',
            formatted_discount: '5,00',
            formatted_price: '81,99',
            dollar: '81',
            cent: '99',
            discount_dollar: '5',
            discount_cent: '00',
...
<Canvas withSource="none" style={{ height: '900px' }}>
    <Story
        name="Drupal - Loading - Plan, Protection, Increment"
        args={{
            elementPath: 'components/card/_doc/template.loading.drupal',
            loadingType: 'plan',
        }}
    >
        {Drupal.bind({})}
...
<Canvas withSource="none" style={{ height: '900px' }}>
    <Story
        name="Drupal - Loading - Phone, Combo"
        args={{
            elementPath: 'components/card/_doc/template.loading.drupal',
            loadingType: 'phone',
        }}
...
<Canvas withSource="none" style={{ height: '900px' }}>
    <Story
        name="Drupal - Loading - Phone - Two Cols Mobile Variant"
        args={{
            elementPath: 'components/card/_doc/template.loading.drupal',
            loadingType: 'phone',
            isTwoColsMobileVariant: true,
