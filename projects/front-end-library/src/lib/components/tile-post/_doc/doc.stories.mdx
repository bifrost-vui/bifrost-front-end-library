...
<Meta
    ...
    decorators={[moduleMetadata({ declarations: [TilePostComponent, TwigContainerComponent] }), withDesign]}
    parameters={{
        design: {
            type: 'figma',
...
export const commonProps = {
    ...
    titleTag: 'h1',
    description:
        '<b>A specific question?</b> Post it on our forum and see how experts and other users have solved a similar problem.',
    link: {
        label: 'Ask a question',
        href: 'https://example.com',
    },
...
<iframe
    width="100%"
    height="450"
    src="https://www.figma.com/embed?embed_host=share&url=https://www.figma.com/file/7bTmk29aCBl7rCFszffYPr/DS---Components-%26-styles?node-id=2806%3A9236"
    frameBorder="0"
    allowFullScreen
></iframe>
