...
export const footerDemo= `<div class='d-flex'><a href='https://www.example.com' class='bf-button bf-button--primary ml-4 mb-3' data-title='primary'><span class='bf-button__label'><span class='bf-button__label__text'>Pimary</span></span></a></div>`;
...
{% embed '@bf-components/modal/twig/index.twig' with {
    ...
    {% block modal_body_scroll_container %}
        // insert custom html or Twig Block here
    {% endblock %}
