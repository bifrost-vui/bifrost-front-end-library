...
<Meta
    ...
    decorators={[moduleMetadata({ declarations: [ModalComponent, TwigContainerComponent] }), withDesign]}
    parameters={{
        design: {
            type: 'figma',
    ...
    argTypes={{
        ...
        modalTheme: { table: { defaultValue: { summary: 'light' } } },
        modalAnimation: { table: { defaultValue: { summary: 'fade' } } },
    }}
/>
...
<Canvas withSource="none" style={{ height: '800px' }}>
    <Story
        ...
        args={{
            ...
            modal_body_subcontainer: modalBodyProps,
            modal_footer: modalFooterProps,
        }}
    >
        {Drupal.bind({})}
    </Story>
...
<Canvas withSource="none" style={{ height: '800px' }}>
    <Story
        name="Drupal - With scrollable content"
        args={{
            elementPath: 'components/modal/_doc/template.drupal',
            modalTitle: 'Title Lorem ipsum dolor sit amet',
            modalSubtitle: 'Subtitle Lorem ipsum dolor sit amet, consectetur adipiscing elit',
            modal_body_scroll_container: modalBodyProps,
            modal_footer: modalFooterProps,
        }}
    >
        {Drupal.bind({})}
