...
import { InputTextComponent }           from '../angular/input-text.component'; import {select} from "@ngrx/store";
...
>
    <Story
        ...
        args={{
            ...
            info            : { text: 'forgot your password?', url: 'https://www.example.com'},
            validationTitle : 'Make sure you have :',
            validationList  : [
                { label:'1 lowercase letter', color:'success', class:'' },
                { label:'1 capital letter', color:'unknown', class:'' },
                { label:'1 number', color: 'progress', class:'' },
                { label:'7 characters', color:'failed', class: null },
                { label: null, color: null, class: null } // test to make sure it doesn't generate a line
            ]
        }}
    >
        {Drupal.bind({})}
