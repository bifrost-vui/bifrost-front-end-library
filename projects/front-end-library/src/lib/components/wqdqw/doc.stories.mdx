...
import { WqdqwComponent } from './angular/wqdqw.component';

<Meta 
    title='Components/Wqdqw' 
    component={WqdqwComponent}
    decorators={[
        moduleMetadata({ declarations: [WqdqwComponent, TwigContainerComponent]}),
        withDesign
    ]}
    parameters={{
        design: {
...
<Preview>
    <Story 
        name='Drupal'
        args={{ 
            elementPath: 'components/wqdqw/twig/wqdqw',
            label: 'Drupal Label',
        }}
        height='150px'
    >
