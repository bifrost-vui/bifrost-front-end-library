...
$(function () {
    ...
    const navItem = '.js-bf-old-megamenu__nav-item';
    const navLink = '.js-bf-old-megamenu__nav-link';
    const navClose = '.js-bf-old-megamenu__close';
    const navFullHeight = '.js-bf-old-megamenu__full-height';
    ...
    $(navLink, navMain).on('click', function (e) {
        ...
        if ($(this).parents(navItem).hasClass('open')) {
            ...
            $(this).parents(navItem).toggleClass('open js-new-tab').trigger('dropdownOpen');
...
$(function () {
    ...
    $(navLink).keydown(function (e) {
        if (e.which == keyTab) {
            ...
            if (e.shiftKey === true) {
                ...
                let $megamenuTabs = $(tabsTab + '.active')
                    .parent()
                    .find(tabsTab);
    ...
    $(tabsTab).keydown(function (e) {
        if (e.which == keyTab) {
            const $parent = $(this).parents().closest('.js-bf-old-megamenu__panel');
            ...
            let $megamenuItemsDropdown = $('.js-bf-old-megamenu__nav-item');
            ...
            if (e.shiftKey === false) {
                if ($megamenuItems.last().is(':focus')) {
                    ...
                    if ($itemActive.next().length > 0) {
                        $itemActive.next().find('.js-bf-old-megamenu__nav-link').focus();
                    } else {
    ...
    $(searchBtn).keydown(function (e) {
        ...
        if (e.which == keyTab && e.shiftKey) {
            ...
            let $megamenuDropdownItem = $('.js-bf-old-megamenu__nav-item.open');
            let $megamenuDropdownNext = $megamenuDropdownItem.next().children();
