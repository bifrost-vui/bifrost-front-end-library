...
import { QwdqwdComponent } from './angular/qwdqwd.component';

<Meta 
    title='Components/Qwdqwd' 
    component={QwdqwdComponent}
    decorators={[
        moduleMetadata({ declarations: [QwdqwdComponent, TwigContainerComponent]}),
        withDesign
    ]}
    parameters={{
        design: {
...
<Preview>
    <Story 
        name='Drupal'
        args={{ 
            elementPath: 'components/qwdqwd/twig/qwdqwd',
            label: 'Drupal Label',
        }}
        height='150px'
    >
