...
import ImageComponentAPIDebug from '../_images/component-api-debug.png';
import ImageComponentPathDebug from '../_images/component-path-debug.png';
...
Create a library **your-theme.libraries.yml** to add the global style from **style-drupal.css**:
```js
global-styling:
  css:
    theme:
        'node_modules/bifrost-front-end-library/assets/styles/style-drupal.css': {}
```
...
**👉 We will start with the Button component.**

### Components Path
- In your terminal, run `node node_modules/bifrost-front-end-library/scripts/migration` to replace all path to PatternLab with the new architecture.
