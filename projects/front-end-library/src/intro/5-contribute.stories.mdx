...
# Contribute
This page will help you to create or update a component in the design System. We will consider both Drupal and Angular.

<br/>

### 2. Generate the structure of your new component 
`npm run generate component <component-name>`

Or copy `.templates/component-structure` folder and paste it in `/lib/components`.
...
> Since Drupal components are server side, you need to refresh the browser to see changes during development. It's real-time in Angular.
